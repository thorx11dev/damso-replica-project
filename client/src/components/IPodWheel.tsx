  ...
  return (
    <div className="fixed bottom-8 left-1/2 -translate-x-1/2 z-50 animate-float">
      <div className="relative w-[160px] h-[160px] group">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[80px] h-[80px] rounded-full bg-accent transition-all duration-300 group-hover:bg-primary/90" />
